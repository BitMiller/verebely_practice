...
e_userName.addEventListener("change", (event) => { checkField_userName(event.target); });
e_eMail.addEventListener("change", (event) => { checkField_eMail(event.target); });
e_phone.addEventListener("change", (event) => { checkField_phone(event.target); });
e_birth.addEventListener("change", (event) => { checkField_birth(event.target); });
e_password.addEventListener("change", (event) => { checkField_password(event.target); });
e_password2.addEventListener("change", (event) => { checkField_password2(event.target); });
